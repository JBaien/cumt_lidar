...
"""autogenerated by genpy from timoo_msgs/timooScan.msg. Do not edit."""
import codecs
import sys
...
import genpy
import std_msgs.msg
import timoo_msgs.msg

class timooScan(genpy.Message):
  _md5sum = "577be07a7422add7a083c04c69c02d07"
  _type = "timoo_msgs/timooScan"
...
bool gps_status         # gps status from DISOP"""
  ...
  _slot_types = ['std_msgs/Header','timoo_msgs/timooPacket[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(timooScan, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = timoo_msgs.msg.timooPacket()
        _v3 = val1.stamp
        _x = _v3
        start = end
        end += 8
        ...
        (val1.gps_status,) = _get_struct_B().unpack(str[start:end])
        val1.gps_status = bool(val1.gps_status)
