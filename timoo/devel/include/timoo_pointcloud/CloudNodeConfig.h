...
#ifndef __timoo_pointcloud__CLOUDNODECONFIG_H__
#define __timoo_pointcloud__CLOUDNODECONFIG_H__
...
namespace timoo_pointcloud
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(CloudNodeConfig &config, const CloudNodeConfig &max, const CloudNodeConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const CloudNodeConfig &config1, const CloudNodeConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, CloudNodeConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const CloudNodeConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, CloudNodeConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const CloudNodeConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const CloudNodeConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, CloudNodeConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.target_frame = "timoo";
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
