...
if("TRUE" STREQUAL "TRUE")
  set(multi_lidar_calibrator_SOURCE_PREFIX /home/sf/Desktop/SLAM/multi_lidar/src/multi_lidar_calibration)
  set(multi_lidar_calibrator_DEVEL_PREFIX /home/sf/Desktop/SLAM/multi_lidar/devel)
  ...
  set(multi_lidar_calibrator_INSTALL_PREFIX /home/sf/Desktop/SLAM/multi_lidar/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'adamshan <zebang.shen@daimler.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multi_lidar_calibrator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sf/Desktop/SLAM/multi_lidar/src/multi_lidar_calibration/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sf/Desktop/SLAM/multi_lidar/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(multi_lidar_calibrator_EXPORTED_TARGETS ${${multi_lidar_calibrator_dep}_EXPORTED_TARGETS})
endforeach()
